# friend_finder
 ...
 ```
A compatibility-based "FriendFinder". This full-stack site will
take in results from the users' surveys, then compare their answers with those from other users. The app 
...
https://floating-crag-15440.herokuapp.com
